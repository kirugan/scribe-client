...
class FacebookServiceClient implements \Kirugan\Scribe\Autogenerated\FacebookServiceIf
{
    ...
    {
        $args = new \Kirugan\Scribe\Autogenerated\FacebookService_getName_args();
    ...
    public function recv_getName()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\Kirugan\Scribe\Autogenerated\FacebookService_getName_result',
            ...
            $result = new \Kirugan\Scribe\Autogenerated\FacebookService_getName_result();
    ...
    {
        $args = new \Kirugan\Scribe\Autogenerated\FacebookService_getVersion_args();
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
                $this->output_,
    ...
    public function recv_getVersion()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\Kirugan\Scribe\Autogenerated\FacebookService_getVersion_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \Kirugan\Scribe\Autogenerated\FacebookService_getVersion_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Kirugan\Scribe\Autogenerated\FacebookService_getStatus_args();
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
                $this->output_,
    ...
    public function recv_getStatus()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\Kirugan\Scribe\Autogenerated\FacebookService_getStatus_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \Kirugan\Scribe\Autogenerated\FacebookService_getStatus_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Kirugan\Scribe\Autogenerated\FacebookService_getStatusDetails_args();
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
                $this->output_,
    ...
    public function recv_getStatusDetails()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\Kirugan\Scribe\Autogenerated\FacebookService_getStatusDetails_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \Kirugan\Scribe\Autogenerated\FacebookService_getStatusDetails_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Kirugan\Scribe\Autogenerated\FacebookService_getCounters_args();
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
                $this->output_,
    ...
    public function recv_getCounters()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\Kirugan\Scribe\Autogenerated\FacebookService_getCounters_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \Kirugan\Scribe\Autogenerated\FacebookService_getCounters_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Kirugan\Scribe\Autogenerated\FacebookService_getCounter_args();
        $args->key = $key;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
    ...
    public function recv_getCounter()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\Kirugan\Scribe\Autogenerated\FacebookService_getCounter_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \Kirugan\Scribe\Autogenerated\FacebookService_getCounter_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Kirugan\Scribe\Autogenerated\FacebookService_setOption_args();
        $args->key = $key;
        $args->value = $value;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_setOption()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\Kirugan\Scribe\Autogenerated\FacebookService_setOption_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \Kirugan\Scribe\Autogenerated\FacebookService_setOption_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        return;
    ...
    {
        $args = new \Kirugan\Scribe\Autogenerated\FacebookService_getOption_args();
        $args->key = $key;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
    ...
    public function recv_getOption()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\Kirugan\Scribe\Autogenerated\FacebookService_getOption_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \Kirugan\Scribe\Autogenerated\FacebookService_getOption_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Kirugan\Scribe\Autogenerated\FacebookService_getOptions_args();
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
                $this->output_,
    ...
    public function recv_getOptions()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\Kirugan\Scribe\Autogenerated\FacebookService_getOptions_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \Kirugan\Scribe\Autogenerated\FacebookService_getOptions_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Kirugan\Scribe\Autogenerated\FacebookService_getCpuProfile_args();
    ...
    public function recv_getCpuProfile()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\Kirugan\Scribe\Autogenerated\FacebookService_getCpuProfile_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \Kirugan\Scribe\Autogenerated\FacebookService_getCpuProfile_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Kirugan\Scribe\Autogenerated\FacebookService_aliveSince_args();
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
                $this->output_,
    ...
    public function recv_aliveSince()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\Kirugan\Scribe\Autogenerated\FacebookService_aliveSince_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \Kirugan\Scribe\Autogenerated\FacebookService_aliveSince_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Kirugan\Scribe\Autogenerated\FacebookService_reinitialize_args();
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
                $this->output_,
    ...
    {
        $args = new \Kirugan\Scribe\Autogenerated\FacebookService_shutdown_args();
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
                $this->output_,
